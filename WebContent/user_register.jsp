...
<script>
	...
	function checkUsername(){
		...
		if(username.value.length<5 || username.value.length>10){
			...
			//建立连接
			xhr.open("get", "CheckUsernameServlet?username=" + encodeURI(username.value) + "&time=" + new Date().getTime(), true);
...
<form action="UserRegisterServlet" method="post" enctype="multipart/form-data" onsubmit="return checkData()">
	...
	<table align="center">
		...
		<tr>
			<td>头像</td>
			<td>
				<input type="radio" name="photo" value="1.gif" onclick="changePhoto()" checked/> <img src="image/photo/1.gif"/> 
				...
				<br>
				<input type="radio" name="photo" id="photo" value="0.gif" onclick="changePhoto()" /> 
				自定义头像上传
